...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__site__ = __webpack_require__(2032);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_helper__ = __webpack_require__(80);
...
var CoreLoginSitePage = /** @class */ (function () {
        ...
        if (siteData) {
            ...
            this.sitesProvider.checkSite(url).then(function (result) {
                ...
                if (_this.loginHelper.isSSOLoginNeeded(result.code)) {
                    ...
                    _this.navCtrl.push('PfLoginCredentialsPage', { siteUrl: result.siteUrl, siteConfig: result.config });
    ...
    CoreLoginSitePage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* NavController */], __WEBPACK_IMPORTED_MODULE_7__angular_forms__["a" /* FormBuilder */], __WEBPACK_IMPORTED_MODULE_2__providers_app__["a" /* CoreAppProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* ModalController */], __WEBPACK_IMPORTED_MODULE_4__providers_utils_dom__["a" /* CoreDomUtilsProvider */]])
    ], CoreLoginSitePage);
